...
public class FlowerArea : MonoBehaviour
{
    ...
    //Diameter of the area where the agent and flowers can be used for observing relative distance from agent to flower
    ...
    /// </summary>
    /// <param name="parent">The parent of a children transform</param>
    private void FindChildFlowers(Transform parent)
    {
        for (int i = 0; i < parent.childCount; i++)
        {
            ...
            if (child.CompareTag("flower_plant"))
            {
                ...
                //Look for flowers within flower plants
